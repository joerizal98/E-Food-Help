...
<html lang="en">
   ...
   <body class="main-layout footer_to90 about_page">
      ...
      <br>
         <div class="container">
         <div class="news_img">
         <figure><img src="images/news_img1.jpg" style = "margin-left: 400px; width: 300px; height:300px "></figure >
                        </div>
                        </div>
                     </div>
                     <div class="col-md-7">
                        ...
                        <br>
                          <h3> Johor Rice Aid <span style="margin-left: 670px; ">14 April 2022</span> </h3>
                           <p align="justify">The special incentive of the Johor State Government, namely Bantuan Kasih Bangsa Johor was announced by YAB Datuk Onn Hafiz Ghazi, Menteri Besar of Johor through a special announcement today, 14 April 2022.</p>
                           <p align="justify">A total of RM144.36 million has been allocated for Bantuan Kasih Bangsa Johor covering five main categories, namely Community, Welfare, Johor Youth, Education and Economy with 28 initiatives that will benefit 3.69 million people in Johor.</p>
                        </div>
                     </div>
                <br>
            </div>
          ...
          <div class="col-md-10 offset-md-1">
                     <form id="request" class="main_form" style="background-color: #ffffff" action="insert_com.php" method="post"><br>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6 col-sm-6">
                                 <label type="label" name="titlelbl"><h4>Title : Johor Rice Aid</h4></label>
                                 <input class="contactus" type="hidden" name="title" value="Title : Johor Rice Aid">
                              </div>
