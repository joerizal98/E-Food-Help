...
<html lang="en">
   ...
   <body class="main-layout footer_to90 about_page">
      ...
      <br>
         <div class="container">
         <div class="news_img">
         <figure><img src="images/news_img2.jpg" style = "margin-left: 350px; width: 400px; height:300px "></figure >
                        </div>
                        </div>
                     </div>
                     <div class="col-md-7">
                        ...
                        <br>
                          <h3> Love My Home 2022: Repair An Elderly Home <span style="margin-left: 300px; ">31 May 2022</span> </h3>
                           <p align="justify">Assistance to repair and rebuild damaged houses and dilapidated houses is now offered to eligible applicants.
                           <p align="justify">This program offers assistance to repair and build new houses WITHOUT PAYMENT for the people of Perak who have suffered damage to houses and dilapidated houses.</p>
                           <p align="justify">There are 2 types of assistance offered, which is</p>
                           <p align="justify">1. Help Good Recover - Assistance for those who have a home that is still economical to repair. </p>
                           <p align="justify">2. New Build Assistance - Help for those who do not own a house or live in a house that is too old or not safe to occupy.</p>
                        </div>
                     </div>
                <br>
            </div>
          ...
          <div class="col-md-10 offset-md-1">
                    <form id="request" class="main_form" style="background-color: #ffffff" action="insert_com.php" method="post"><br>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6 col-sm-6">
                                 <label type="label" name="titlelbl"><h4>Title : Repair An Elderly Home</h4></label>
                                 <input class="contactus" type="hidden" name="title" value="Title : Repair An Elderly Home">
                              </div>
