            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-10 offset-md-1">
                        <form id="request" class="main_form" method = "post" action="insert_contact.php">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-12">
                              <input class="contactusmess" placeholder="Message" type="type" Message="Name" name="msg">
                           </div>
                           <div class="col-md-12">
                              <button class="send_btn" name="insert_contact">Send</button>
                           </div>
                        </div>
                     </form><br>
                  </div>
